...
USE_MAT_ROTARY_ENC = True # set to True to use matrix rotary encoding implementation， which is more onnx friendly. apply_rotary_enc is more efficient though, but export to onnx will be failed.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if USE_MAT_ROTARY_ENC:
            self.rotmats = get_rotation_matrices(dim=self.internal_dim // self.num_heads, end_x=feat_sizes[0], end_y=feat_sizes[1], theta=rope_theta)
